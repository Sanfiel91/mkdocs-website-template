...
<div class="proof-strip">
  ...
  <span class="proof-chip">40% better retrieval accuracy</span>
  <span class="proof-chip">500+ daily API requests served</span>
</div>
...
-   :material-robot:{ .lg .middle } **Agentic AI systems**
...
-   :material-compass-outline:{ .lg .middle } **1. Clarify the target system**
...
[Read more about my background :material-arrow-right:](about.md){ .md-button }
</div>
